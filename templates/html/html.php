...
// Page title
$title = ($page->parent() ? $page->name().' &ndash; ' : '').$servant->site()->name();
...
$meta .= '<meta property="og:type" content="'.(!$page->parent() ? 'website' : 'article').'"><meta property="og:url" content="'.$servant->paths()->root('url').'">';
