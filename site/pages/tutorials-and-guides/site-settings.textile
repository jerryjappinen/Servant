...
"pageNames": {
	"technical-docs/basics/text-and-markdown": "Text & Markdown",
	"technical-docs/basics/url-manipulation": "URL manipulation"
}
"pageOrder": [
	"tutorials-and-guides",
	"technical-docs",
	"technical-docs/basics"
	"technical-docs/template-formats"
]
"pageTemplates": [
	"about": "blog"
]
...
|*name*||
|*description*||
|*icon*<br>Path (relative to Servant root) to an icon image file.<br>Use @.png@, @.jpg@ or @.ico@ files.|@"site/favicon.png"@|
|*splashImage*<br>Path (relative to Servant root) to an splash image file.|@"site/splash.png"@|
...
|_. Supported setting|_. Example values|
|*browserCache*<br>Suggested caching time for browsers, in minutes.| @"3*60"@ |
|*serverCache*<br>Caching time used by Servant, in minutes.| @"2*24*60"@ |
