...
*/
class NewUrlManipulator {

	/**
	* URLs in HTML
	*/
	public function legacyHtmlUrls ($string, $srcRootPath, $srcRelativePath = '', $hrefRootPath = null, $hrefRelativePath = '', $actionsPath = null) {
	...
	* URLs in CSS
	*/
	public function legacyCssUrls ($string, $rootPath, $relativePath = '', $actionsPath = null) {
