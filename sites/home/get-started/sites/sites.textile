...
Servant will create menus, fancy URLs, sitemaps, stylesheets and much more for each site. You can have as many sites as you want. Each site will use "_one template_ and one _theme_":templates-and-themes, so you can choose the structure and the look that you like.
